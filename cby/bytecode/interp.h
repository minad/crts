...
OP_BEGIN(thk0)
    ...
    Chili clos = NEW(CHI_THUNKFN, CHI_SIZEOF_WORDS(CbyFn) + 0);
...
OP_BEGIN(thk1)
    ...
    Chili clos = NEW(CHI_THUNKFN, CHI_SIZEOF_WORDS(CbyFn) + 1);
    *res = chiThunkInit(NEW(CHI_THUNK, 1), clos);
    CbyFn* fn = chiToCbyFn(clos);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
...
OP_BEGIN(thk2)
    ...
    Chili clos = NEW(CHI_THUNKFN, CHI_SIZEOF_WORDS(CbyFn) + 2);
    *res = chiThunkInit(NEW(CHI_THUNK, 1), clos);
    CbyFn* fn = chiToCbyFn(clos);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
...
OP_BEGIN(thk3)
    ...
    Chili clos = NEW(CHI_THUNKFN, CHI_SIZEOF_WORDS(CbyFn) + 3);
    *res = chiThunkInit(NEW(CHI_THUNK, 1), clos);
    CbyFn* fn = chiToCbyFn(clos);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
...
OP_BEGIN(thk4)
    ...
    Chili clos = NEW(CHI_THUNKFN, CHI_SIZEOF_WORDS(CbyFn) + 4);
    *res = chiThunkInit(NEW(CHI_THUNK, 1), clos);
    CbyFn* fn = chiToCbyFn(clos);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
...
OP_BEGIN(fn0)
    ...
    *res = NEW(CHI_FN(arity), CHI_SIZEOF_WORDS(CbyFn) + 0);
    CbyFn* fn = chiToCbyFn(*res);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
    fn->ip = chiFromIP(fnref);
...
OP_BEGIN(fn1)
    ...
    *res = NEW(CHI_FN(arity), CHI_SIZEOF_WORDS(CbyFn) + 1);
    CbyFn* fn = chiToCbyFn(*res);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
    fn->ip = chiFromIP(fnref);
...
OP_BEGIN(fn2)
    ...
    *res = NEW(CHI_FN(arity), CHI_SIZEOF_WORDS(CbyFn) + 2);
    CbyFn* fn = chiToCbyFn(*res);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
    fn->ip = chiFromIP(fnref);
...
OP_BEGIN(fn3)
    ...
    *res = NEW(CHI_FN(arity), CHI_SIZEOF_WORDS(CbyFn) + 3);
    CbyFn* fn = chiToCbyFn(*res);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
    fn->ip = chiFromIP(fnref);
...
OP_BEGIN(fn4)
    ...
    *res = NEW(CHI_FN(arity), CHI_SIZEOF_WORDS(CbyFn) + 4);
    CbyFn* fn = chiToCbyFn(*res);
    fn->fn = chiFromCont(&interpFn);
    fn->module = chiToCbyFn(CURRFN)->module;
    fn->ip = chiFromIP(fnref);
...
OP_BEGIN(app1)
    const Chili fn = REG[FETCH8];
    const Chili a0 = REG[FETCH8];
    if (chiFnArity(fn) == 1 && chiToCont(IDX(fn, 0)) == &interpFn) {
        const CbyCode* fnref = chiToIP(chiToCbyFn(fn)->ip);
        {    SP[0] = a0;
    {    instrumentLeave(proc, &interpPS->data, CURRFN, SP);
    CURRFN = fn;
...
OP_BEGIN(app2)
    ...
    const Chili a0 = REG[FETCH8];
    const Chili a1 = REG[FETCH8];
    if (chiFnArity(fn) == 2 && chiToCont(IDX(fn, 0)) == &interpFn) {
        const CbyCode* fnref = chiToIP(chiToCbyFn(fn)->ip);
        {    SP[0] = a0;
    SP[1] = a1;
    {    instrumentLeave(proc, &interpPS->data, CURRFN, SP);
...
OP_BEGIN(app3)
    ...
    const Chili a1 = REG[FETCH8];
    const Chili a2 = REG[FETCH8];
    if (chiFnArity(fn) == 3 && chiToCont(IDX(fn, 0)) == &interpFn) {
        const CbyCode* fnref = chiToIP(chiToCbyFn(fn)->ip);
        {    SP[0] = a0;
    SP[1] = a1;
    SP[2] = a2;
...
OP_BEGIN(app4)
    ...
    const Chili a2 = REG[FETCH8];
    const Chili a3 = REG[FETCH8];
    if (chiFnArity(fn) == 4 && chiToCont(IDX(fn, 0)) == &interpFn) {
        const CbyCode* fnref = chiToIP(chiToCbyFn(fn)->ip);
        {    SP[0] = a0;
    SP[1] = a1;
    SP[2] = a2;
...
OP_BEGIN(app5)
    ...
    const Chili a3 = REG[FETCH8];
    const Chili a4 = REG[FETCH8];
    if (chiFnArity(fn) == 5 && chiToCont(IDX(fn, 0)) == &interpFn) {
        const CbyCode* fnref = chiToIP(chiToCbyFn(fn)->ip);
        {    SP[0] = a0;
    SP[1] = a1;
    SP[2] = a2;
