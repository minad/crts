...
#define _CALLCONV_JUMP(c)       __tailcall__((ChiContFn*)(c), _chiReg, _chiRegSP, _chiRegSL, _chiRegHP, _chiRegA0, _chiRegA1)
#define _CALLCONV_FIRST_JUMP(c) ({ ((ChiContFn*)(c))(_chiReg, _chiRegSP, _chiRegSL, _chiRegHP, _chiRegA0, _chiRegA1); CHI_UNREACHABLE; })
