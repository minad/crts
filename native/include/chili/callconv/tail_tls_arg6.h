...
#define _CALLCONV_JUMP(c)       __tailcall__((ChiContFn*)(c), _chiRegSP, _chiRegSL, _chiRegHP, _chiRegA0, _chiRegA1, _chiRegA2)
#define _CALLCONV_FIRST_JUMP(c) ({ ((ChiContFn*)(c))(_chiRegSP, _chiRegSL, _chiRegHP, _chiRegA0, _chiRegA1, _chiRegA2); CHI_UNREACHABLE; })
